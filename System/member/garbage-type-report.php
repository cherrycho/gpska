...
<head>
   ...
   <meta name="viewport" content="width=device-width, initial-scale=1">
      <title>GENERASI PEDULI SAMPAH </title>
   <!-- Font Awesome -->
                  ...
                  <div class="row mb-2">
                     ...
                     <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                           ...
                           <li class="breadcrumb-item active">Data Collected</li>
                        </ol>
                     </div>
                  </div>
               </div>
                  ...
                  <div class="card card-info">
                     ...
                     <div class="col-md-12">
                        <table class="table table-bordered mytable">
                           <thead>
                              <td><strong>Type garbage</strong></td>
                              <td>January</td>
                              <td>February</td>
                              <td>March</td>
                              <td>April</td>
                           ...
                           <tbody>
                              <tr>
                                 <td><strong>Plastic Bottels</strong></td>
                                 <td>500</td>
                                 <td>600</td>
                                 <td>700</td>
                                 <td>800</td>
                              ...
                              <tr>
                                 <td><strong>Cigarette Butts</strong></td>
                                 <td>900</td>
                                 <td>1000</td>
                                 <td>1100</td>
                                 <td>1200</td>
                              ...
                              <tr>
                                 <td><strong>Bottels Caps</strong></td>
                                 <td>900</td>
                                 <td>1000</td>
                                 <td>1100</td>
                                 <td>1200</td>
